...
public class UCSBOrganizationControllerTests extends ControllerTestCase {
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_does_not_exist() throws Exception {
                ...
                when(ucsbOrganizationRepository.findById(eq("LeaguofLegends"))).thenReturn(Optional.empty());
                ...
                verify(ucsbOrganizationRepository, times(1)).findById(eq("LeagueofLegends"));
        ...
        public void logged_in_user_can_get_all_ucsborganization() throws Exception {
                ...
                UCSBDiningOrganization SKY = UCSBOrganization.builder()
                                .orgCode("SKY")
